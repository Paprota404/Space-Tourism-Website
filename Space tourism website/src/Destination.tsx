    ...
    <>
     <img
      ...
      >
        ...
        >
          <h5 id="destination">
            <span style={{ opacity: 0.25 }}>01&nbsp;</span> PICK YOUR
            DESTINATION
          </h5>
            ...
            <div id="planets">
              ...
              <a
                ...
                onClick={() =>
                  changePlanet({
                    name: "MARS",
                    desc: "Don’t forget to pack your hiking boots. You’ll need them to tackle Olympus Mons, the tallest planetary mountainin our solar system. It’s two and a half times the size of Everest! I want to fly here someday hehe",
                    dist: "225 mil. km",
                    time: "9 months",
                    link: "/image-mars.png",
                  })
